...
template<class Polynomial>
autoPtr<scalarRectangularMatrix> Foam::FixedPolynomial<Polynomial>::matrix() const
{
    scalarRectangularMatrix* B = new scalarRectangularMatrix(stencil.size(), Polynomial::nTerms(dimensions), scalar(0));
