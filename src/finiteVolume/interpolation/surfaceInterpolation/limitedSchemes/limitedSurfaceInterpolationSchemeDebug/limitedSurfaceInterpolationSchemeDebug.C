...
#include "limitedSurfaceInterpolationSchemeDebug.H"
#include "volFields.H"
...
template<class Type>
Foam::tmp<Foam::limitedSurfaceInterpolationSchemeDebug<Type>>
Foam::limitedSurfaceInterpolationSchemeDebug<Type>::New
(
    const fvMesh& mesh,
    Istream& schemeData
)
{
    ...
    {
        InfoInFunction
            << "Constructing limitedSurfaceInterpolationSchemeDebug<Type>" << endl;
    }
...
)
{
    ...
    {
        InfoInFunction
            << "Constructing limitedSurfaceInterpolationSchemeDebug<Type>"
            << endl;
    }
...
template<class Type>
Foam::limitedSurfaceInterpolationSchemeDebug<Type>::
...
Foam::limitedSurfaceInterpolationSchemeDebug<Type>::weights
(
...
Foam::limitedSurfaceInterpolationSchemeDebug<Type>::flux
(
    const GeometricField<Type, fvPatchField, volMesh>& phi
) const
{
