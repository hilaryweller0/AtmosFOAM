...
template<class Type>
Foam::tmp<Foam::volInterpolationScheme<Type>>
Foam::volInterpolationScheme<Type>::New
(
    const fvMesh& mesh,
    Istream& schemeData
)
{
    ...
    if (volInterpolationScheme<Type>::debug)
    {
...
template<class Type>
Foam::volInterpolationScheme<Type>::~volInterpolationScheme()
{}
