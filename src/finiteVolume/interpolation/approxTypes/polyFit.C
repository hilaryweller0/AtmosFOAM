...
) const
{
    ...
    const scalar centralWeight = 2000;
...
//            << " stencilSize = " << N << " reducing order" << endl;
    ...
    if (centralCell != 0) wts[centralCell] = centralWeight;
    ...
    )
    {
        ...
        (
         ...
         || (max(weights) > weights[0] && max(weights) > weights[centralCell])
         || weights[0] > 1.5
         || weights[0] <= 0 || weights[centralCell] <= 0
        )
        {
//            // Reduce the weight of the non-upwind cell
//            if (wts[centralCell] > 1 && centralCell != 0)
//            {
//                wts[centralCell] /= 10.;
//            }
...
//                << "\nB = " << B
//                 << "\nweights = " << weights << " centralCell = " << centralCell
//                 << endl;
//        
