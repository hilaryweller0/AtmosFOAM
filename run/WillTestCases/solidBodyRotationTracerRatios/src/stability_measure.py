...
if analysis == 1:
    ...
    for n in xrange(len(dt)):
        ...
        os.system( "mv " + os.path.join(base_dir,"{}/T".format(writeInterval)) + " " + os.path.join(base_dir,"T_{}_{}".format(id,n)) )
        os.system( "mv " + os.path.join(base_dir,"{}/T".format(int(round(writeInterval)))) + " " + os.path.join(base_dir,"T_{}_{}".format(id,n)) )
